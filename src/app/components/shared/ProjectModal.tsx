...
export default function ProjectModal({ isVisible, onClose, type }: ModalProps) {
	...
	return (
		<div
			className={`fixed z-50 top-0 left-0 bottom-0 right-0 h-screen w-screen bg-[#000b] ${
...
function CodapModal() {
	...
	const [element, setElement] = useState(
		<p className="text-lg md:text-2xl mb-3">
			...
			<span
				role="button"
				onClick={() =>
					openNewTab("https://codap.gabrielsimoesdeveloper.com.br")
				}
			>
	...
	useEffect(() => {
		...
		if (windowRef.width <= 900) {
			setElement(
				<p
					className="text-lg md:text-2xl mb-3 text-purple-400 font-bold cursor-pointer"
					role="button"
					onClick={() =>
						openNewTab(
							"https://codap.gabrielsimoesdeveloper.com.br"
						)
					}
				>
					<FontelloIcon name={"icon-globe"} /> Site oficial
				</p>
			);
		} else {
			setElement(
			...
			<div className="flex flex-col pt-3">
				<div className={`flex ${align}`}>
					<Image
						...
						aria-hidden
						unoptimized
						style={{ filter: "drop-shadow(0 0 10px #00000070)" }}
					/>
					<div className="flex flex-col mt-5 md:my-auto">
						<p className="text-lg md:text-2xl mb-5">
							...
							é um aplicativo open-source Android desenvolvido em
							React Native por{" "}
							<span
								onClick={() =>
									openNewTab(
							...
							<span
								onClick={() =>
									openNewTab(
										"https://www.linkedin.com/in/gabrielsimoest/"
									)
								}
							>
								Gabriel Simões
							</span>{" "}
							como proposta para o 14º desafio da engenharia da
							computação na Universidade de Ribeirão Preto
							(UNAERP), conquistando o primeiro lugar no desafio.
						</p>
						<p className="text-lg md:text-2xl mb-5">
							O objetivo do{" "}
							<span
							...
							é proporcionar uma educação prática em HTML, CSS e
							JavaScript para futuros desenvolvedores web. O
							aplicativo oferece diversas aulas interativas que
							permitem explorar e aprender sobre os fundamentos
							básicos e avançados do desenvolvimento web.
						</p>
						{element}
						<p
							className="text-lg md:text-2xl w-fit font-bold text-purple-400 cursor-pointer"
							role="button"
							onClick={() =>
								openNewTab(
									"https://github.com/gabrielsimoest/Codap"
								)
							}
						>
							<FontelloIcon
		...
		<>
			...
			<div className={`flex ${align} pt-8 mb-15`}>
				<Image
					...
					aria-hidden
					unoptimized
					style={{ filter: "drop-shadow(0 0 10px #00000060)" }}
				/>
				<p className="text-lg md:text-2xl my-auto">
					<span
						onClick={() => openNewTab("https://powerbeast.com.br")}
						className="project"
					>
						Power Beast
					</span>{" "}
					é um aplicativo de monitoramento e otimização de baterias de
					notebooks dedicado ao público gamer. Desenvolvido
					inicialmente em Go por{" "}
					<span
						onClick={() =>
							openNewTab(
								"https://www.linkedin.com/in/gabriel-reverso-pereira"
					...
					<span
						onClick={() =>
							openNewTab(
								"https://www.linkedin.com/in/felipe-granvile-494b75232/"
							)
						}
					>
						Felipe Granvile
					</span>{" "}
					como proposta para o 16º desafio de engenharia da computação
					na Universidade de Ribeirão Preto (UNAERP), onde alcançou o
					segundo lugar. Refeito recentemente utilizando React e
					Electron, proporcionando uma interface mais intuitiva e
			...
			<div className="flex flex-col lg:flex-row gap-10 mt-5 mb-16">
				<div className="my-auto">
					<p className="text-lg md:text-2xl">
						Além de um otimizador e um overlay para monitoramento da
						bateria, o menu do{" "}
						<span
							onClick={() =>
								openNewTab("https://powerbeast.com.br")
							}
							className="project"
						>
							Power Beast
						</span>{" "}
						conta com as seguintes informações:{" "}
					</p>
				...
				<Image
					...
					aria-hidden
					unoptimized
					style={{ width: dragonWidth }}
				/>
			</div>
			<p className="text-lg md:text-2xl">
				Em informações avançadas é possível ver outras informações como:
				capacidade atual, capacidade de projeto, capacidade total e
				voltagem, além de informações da CPU e da memória RAM.
			</p>
			...
			<p className="mb-10 mt-10 text-lg md:text-2xl">
				Confira o site oficial:{" "}
				<span
					role="button"
					onClick={() => openNewTab("https://powerbeast.com.br")}
		...
		<>
			...
			<div className={`flex ${align} gap-10 pt-5 mb-15`}>
				<Image
					...
					aria-hidden
					unoptimized
					style={{ filter: "drop-shadow(0 0 20px #00000060)" }}
				/>
				<div className="flex flex-col justify-around">
					<p className="text-lg md:text-2xl">
						<span className="project no-link">J.I.R.A</span> é um
						manipulador róbotico com visão computacional, fabricado
						com impressora 3D e motorizado por ESP32. Inicialmente
						desenvolvido por{" "}
						<span
							onClick={() =>
								openNewTab(
									"https://www.linkedin.com/in/otaviormc/"
								)
							}
						>
							Otávio Ribeiro
						...
						<span
							onClick={() =>
								openNewTab(
									"https://www.linkedin.com/in/vitor-ferraz-marini/"
								)
							}
						>
							Vitor Ferraz Marini
						...
						, <span className="project no-link">J.I.R.A</span> é
						capaz de distinguir entre as cores azul, amarelo e
						vermelho e separar elas de acordo com seu algoritimo.
					</p>
					<p className="text-lg md:text-2xl">
						Posteriormente, participei do desenvolvimento de um
						aplicativo multiplataforma utilizando React Native e
						Expo para o{" "}
						<span className="project no-link">J.I.R.A</span>. Este
						aplicativo permite controlar remotamente em tempo real o
						braço robótico através do aplicativo, utilizando uma
						comunicação HTTP com a ESP32.
					</p>
				</div>
			</div>
	...
	return (
		<>
			...
			<div className="flex flex-col pt-10 mb-15">
				<p className="text-lg md:text-2xl">
					<span className="project">Cardapium</span> é um site
					experimental desenvolvido por{" "}
					<span
						onClick={() =>
							openNewTab(
								"https://www.linkedin.com/in/gabriel-reverso-pereira"
					...
					. Utilizando Vue.js e Tailwind, o site conta com um servidor
					PHP para simular um cardápio online.
				</p>
				<p className="text-lg md:text-2xl mt-5">
					O site possui código aberto e permite realizar login e
					cadastro. Além disso, os usuários podem efetuar pedidos de
					forma interativa.
				</p>
			</div>
			...
			<p
				...
				role="button"
				onClick={() =>
					openNewTab("https://github.com/GabrielReverso/cardapium")
				}
			>
				<FontelloIcon name={"icon-github-circled"} />
				Repositório do GitHub
			</p>
		</>
	);
...
function EnciclopetModal() {
	...
	return (
		<>
			...
			<div className="flex flex-col pt-10 mb-15">
				<p className="text-lg md:text-2xl">
					<span className="project no-link">Enciclopet</span> é um
					aplicativo guia de raças multiplataforma desenvolvido em
					React Native e Expo por{" "}
					<span
						onClick={() =>
							openNewTab(
								"https://www.linkedin.com/in/gabriel-reverso-pereira"
					...
					<span
						onClick={() =>
							openNewTab(
								"https://www.linkedin.com/in/antony-lampa-a834a32ab/"
							)
						}
					>
						Antony Lampa
					</span>{" "}
					como proposta para o 18º desafio da engenharia da computação
					na Universidade de Ribeirão Preto (UNAERP), chegando nas
					finais do desafio.
				</p>
				<p className="text-lg md:text-2xl mt-5">
					O aplicativo contém mais de 50 raças de cães e gatos para os
					usuários explorarem e descobrir. Além disso, possui uma
					seção dedicada às doenças mais comuns que os pets podem ter.
				</p>
			</div>
			<div className="flex flex-row flex-wrap justify-center gap-10 mt-10">
				<Image
